 ...
 */
package com.daiduo.lightning.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			...
			"com.daiduo.lightning.messages.scenes.scenes",
			"com.daiduo.lightning.messages.ui.ui",
			"com.daiduo.lightning.messages.windows.windows",
			"com.daiduo.lightning.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.daiduo.lightning.", "");
			key += "." + k;
		} else
			key = k;
