...
import com.daiduo.lightning.windows.WndClass;
...
/**
 * Created by badcw on 2017/7/18.
 */

public class StartScene2 extends PixelScene {
    ...
    public void create() {
        ...
        btnNewGame = new GameButton(Messages.get(this, "new")) {
            ...
            protected void onClick() {
                if (GamesInProgress.check(curClass) != null) {
                    Gizmo add = StartScene2.this.add(new WndOptions(
        ...
        if (ShatteredPixelDungeon.landscape()) {
            ...
            Badges.loadingListener = new Callback() {
                @Override
                public void call() {
                    if (Game.scene() == StartScene2.this) {
